...
class Post extends \FME\Applyfortradeaccount\Controller\Index
{
        
        const CONFIG_CAPTCHA_ENABLE = 'applyfortradeaccount/google_options/captchastatus';
        const CONFIG_CAPTCHA_PRIVATE_KEY = 'applyfortradeaccount/google_options/googleprivatekey';
    ...
    public function execute()
    {
        ...
        if (!\Zend_Validate::is(trim($post['options']), 'NotEmpty')) {
            $error = true;
        }
...
/*Save Data Start*/
                ...
                $this->_redirect('applyfortradeaccount/index');
                return;
            } catch (\Exception $e) {
