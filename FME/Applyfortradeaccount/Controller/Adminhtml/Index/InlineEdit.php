...
use FME\Applyfortradeaccount\Model\Applyfortradeaccount as ModelApplyfortradeaccount;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        ModelApplyfortradeaccount $rfqModel,
     ...
     * @return void
     */
    protected function validatePost(array $pageData, ModelApplyfortradeaccount $page, &$error, array &$messages)
    {
     ...
     * @return string
     */
    protected function getErrorWithPageId(ModelApplyfortradeaccount $page, $errorText)
    {
     ...
     * @return $this
     */
    public function setRfqData(ModelApplyfortradeaccount $page, array $extendedPageData, array $pageData)
    {
