    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->_eventManager->dispatch(
                'applyfortradeaccount_prepare_save',
                ['applyfortradeaccount' => $model, 'request' => $this->getRequest()]
            );
            ...
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['applyfortradeaccount_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['applyfortradeaccount_id' => $this->getRequest()->getParam('applyfortradeaccount_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
