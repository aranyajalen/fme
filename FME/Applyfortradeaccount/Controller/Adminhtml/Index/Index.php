...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('FME_Applyfortradeaccount::applyfortradeaccount');
        $resultPage->addBreadcrumb(__('Trade Account'), __('Trade Account'));
        $resultPage->addBreadcrumb(__('Manage Quotes'), __('Manage Quotes'));
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Trade Account'));
